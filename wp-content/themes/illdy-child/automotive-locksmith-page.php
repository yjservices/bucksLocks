<?php
/*
* Template Name: AutomotiveLocksmith-page
*/

function metaDescription() {
    ?>
        <meta name="keywords" content="Automotive Locksmith in Bucks County PA, 24 hours car lockout, Automotive Locksmith services in Bucks County PA, newtown-locksmith, Bucks County, PA Locksmith,Vehicle lockouts, car lockout service, car opening service, Locksmith around me, automotive keys in Bucks County PA, make car key in Bucks County PA, replacement car keys, duplicate keys, transponder key, get new car keys, cheap car keys, auto Locksmith">
        <meta name="description" content="Automotive Locksmith services in Bucks county, PA. At BucksLocks, we offer a wide range of Automotive Locksmith services. Lost car keys, need a new remote, need to make a copy of your car keys or just looking for a vehicle lockout service. We strive to provide superior Locksmith aid 24/7, 365 days a year">
	<?php
}
...
?>
        ...
        <header id="header" class="automotive-locksmith-services"  style="<?php echo $style ?>" title="Automotive Locksmith in Bucks County header image">
		...
		<div class="container">
			<div class="row">
                ...
                <div id="header-title-text">				
                    <h3>Locksmith in Bucks County PA.</h3>
				...
				<section class="front-page-section" id="static-page-content">
					<div class="section-header">
						<div class="container">
							<div class="row">
								<div class="col-sm-12">
                                   <h2 class="header-section-text service-page">Automotive Locksmith in Bucks County PA</h2>
								</div><!--/.col-sm-12-->
							</div><!--/.row-->
						</div><!--/.container-->
					</div><!--/.section-header-->
						...
						<div class="container-fluid">							
                                                    <div class="row">
                                                        <div class="col-sm-4 col-sm-offset-1 col-md-5 col-md-offset-1 col-lg-4 col-lg-offset-1 service-section-img-container">
                                                            <img src="<?php echo get_stylesheet_directory_uri() ?>/layout/images/replacement_car_key.jpg" alt="car key duplication in Bucks County PA" title="replace Car Keys in Bucks County PA">
                                                        </div>
                                                        <div class="col-sm-6 col-md-5 col-lg-5 col-lg-offset-1 service-section-text-contianer" style="text-align: left">
                                                           <p>
                                                            <h6>24/7 Automotive Locksmith in Bucks County PA</h6>
                                                           Are you locked out of your car and looking for a locksmith in Bucks County PA? Did your key break in your ignition? Did
                                                           you lose your car key? Do you want to replace your car key? BucksLocks offers 24 7 automotive Locksmith emergency 
                                                           mobile service to Bucks County PA and its surroundings. We will come to your location, and fix your locksmith issue.
                                                           From 24 hours car opening service to replacement of car keys in Bucks county.
                                                           Call now for reliable and dependable automotive locksmith service. Our locksmith professionals are always on standby and ready to go.
                                                            ...
                                                            Lost your Car Keys?
                                                                ...
                                                                No Worries, Bucks Locks provides mobile car keys replacement service around the clock to the entire Bucks County PA area. We are
                                                                available for you 24 hours a day 7 days a week. We make car keys for most vehicles.                                                                  
                                                                Do not wait till you lose your car keys. Contact BucksLocks and get a spare car key in a cheap price.
                                                                Call us now and will send one of our automotive locksmith technicians to cut and program your car keys.
                                                            </p>
                                                            <p>
                                                            <h6>Need a Keyless Entry Remote ?</h6>
                                                            As an automotive locksmith company, in addition to car keys duplication service, BucksLocks provides keyless entry remote repair and 
                                                            new remote programming to residents of Bucks County PA.
                                                        ...
                                                        <div id="locksmith-images-carousel" class="carousel slide" data-ride="carousel">
                                                            ...
                                                            <div class="carousel-inner">
                                                              <div class="item active">
                                                                  <img src="<?php echo get_stylesheet_directory_uri() ?>/layout/images/carKey_new.jpg" alt="Car Keys Replacement in Bucks County PA" title="Car Keys Replacement in Bucks County PA">
                                                              </div>

                                                              <div class="item">
                                                                  <img src="<?php echo get_stylesheet_directory_uri() ?>/layout/images/repair_car_keys.jpg" alt="repair car keys in Bucks County PA in Bucks County PA" title="Car Key Repair in Bucks County PA in Bucks County PA">
                                                              </div>

                                                              <div class="item">
                                                                  <img src="<?php echo get_stylesheet_directory_uri() ?>/layout/images/emergency_locksmith_door_lockout.jpg" alt="Emeregency Auto Locksmith in Bucks County PA" title="Emeregency Auto Locksmith in Bucks County PA">
                                                              </div>
                                                            </div>
                                                          </div>                                                        								                                                               
                                                        </div>
