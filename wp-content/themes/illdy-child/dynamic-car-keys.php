<?php
/*
* Template Name: dynamic-car-keys
*/
...
function metaDescription() {
    ?>
    <meta name="keywords" content="best car keys in your area, best Key to my Honda, Mobile best car keys services around you, best car keys, lost keys, replacemnet Keys to vehicle o my Ford,replace lost car key, originate lost car keys, lost chip car key, program new lost keys, duplicate car keys, Lost transponder key, auto lost keys solutions, affordable replacement of lost car keys, cut new car keys, lost Key to my Jeep, Buckslocks replacement car keys, Spare car key, keyless remote">
        ...
        <div class="container">
            <div class="row">
                ...
                <div id="header-title-text">      
                    <h3>Best Car Keys Service in <?php echo $location ?>!</h3>
...
<div id="header-title-text-mobile">        
    <h3 style="font-size: 2em">Best Car Keys Service in <?php echo $location ?>!</h3>
    <h4>Available 24 Hours 7 Days a Week.</h4>
    <h4>Reliable and Dependable Service.</h4>
    <p>Call now!  </p>
    <div class="cta-hedear-title">                
                ...
                <section class="front-page-section" id="static-page-content">
                    <div class="section-header">
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h2 class="header-section-text service-page">Car Keys Replacement in <?php echo $location ?></h2>                          
                                </div><!--/.col-sm-12-->
                            </div><!--/.row-->
                        </div><!--/.container-->
                    </div><!--/.section-header-->
                        ...
                        <div class="container-fluid">                           
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-5 col-lg-5 col-lg-offset-1 service-section-text-contianer" style="text-align: left">                                                            
                                  ...
                                  <p>
                                      BucksLocks is the best car keys replacement mobile service in <?php echo $location ?>. We offers car key replacements at affordable prices for 24 hours every day anywhere in <?php echo $location ?>. Well, you don’t need to pay so much to a dealer to get a new key. The great thing about our
                            ...
                            <div class="row">
                                <div class="col-sm-12  col-md-10 col-md-offset-1  col-lg-10 col-lg-offset-1 service-section-text-contianer" style="text-align: center">                            
                                       <h4 style="font-size: 21px;">Looking for mobile car keys service in <?php echo $location ?>? Worry no more! </h4>
                                ...
                                <div class="col-sm-11 col-sm-offset-1 service-section-text-contianer" style="text-align: left">
                                 And any other key services you need in <?php echo $location ?>, <?php echo $state; ?>
                                 </div>
                            </div>        
                        </div>
                    </div>
