<?php
/*
* Template Name: CommercialLocksmith-page
*/
function metaDescription() {
    ?>
        <meta name="keywords" content="Locksmith in Bucks County, PA, Commercial Locksmith services in Bucks county, Bucks County-locksmith, Bucks County, Bucks county PA commercial Locksmith, Panic bar replacement, access entry, security system installation, professional locksmith, door lockouts service in bucks county pa, high security locks at bucks county pa">
        <meta name="description" content="Commercial Locksmith services in Bucks county, PA. At BucksLocks, we offer a wide range of Commercial Locksmith services. Lost your keys, need a high security door lock for your business, need to install security system or just looking for a lockout service. We strive to provide superior Locksmith aid 24/7, 365 days a year">
	<?php
}
...
?>
 ...
 style="<?php echo $style ?>" title="commercial locksmith in Bucks County,PA header image">
						...
						<div class="container-fluid">							
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-5 col-sm-offset-1 col-md-5 col-md-offset-1 col-lg-4 col-lg-offset-1 service-section-text-contianer" style="text-align: left">
                                                            ...
                                                            <ul>
                                                                <li>24 hour commercial locksmith services</li>
