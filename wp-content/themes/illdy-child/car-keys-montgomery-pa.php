<?php
/*
* Template Name: car-keys-montgomery-county-pa
*/
function metaDescription() {
    ?>
        <meta name="keywords" content="replacement car keys in Montgomery County PA, Automotive Locksmith services, Montgomery County-locksmith, Montgomery County PA car keys,Vehicle keys in Montgomery County, get new car key in Montgomery County, make-car-key, chip car key, program keys, duplicate car keys, transponder key, auto Locksmith, program car remote, affordable car keys, cut new car keys, Buckslocks in Montgomery County PA, Spare car key Montgomery County, keyless remote">
        <meta name="description" content="Car Keys Replacement services in Montgomery County, PA. At BucksLocks, we offer a wide range of Automotive Locksmith services. Lost car keys, need a new remote, need to make a copy of your car keys or just looking for a vehicle lockout service. We strive to provide superior car replacement services aid 24/7, 365 days a year">   
    <?php
}
...
?>
        ...
        <header id="header" class="automotive-locksmith-services"    style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/layout/images/new_car_keys_3.jpg') !important" title="get new car keys" >
		...
		<div class="container">
			<div class="row">
                ...
                <div id="header-title-text">				
                    <h3>Car Keys Replacement in Montgomery County, PA.</h3>
				...
				<section class="front-page-section" id="static-page-content">
					<div class="section-header">
						<div class="container">
							<div class="row">
								<div class="col-sm-12">
                                                                    <h2 class="header-section-text service-page">Replacement Car Keys in Montgomery County PA</h2>
								</div><!--/.col-sm-12-->
							</div><!--/.row-->
						</div><!--/.container-->
					</div><!--/.section-header-->
						...
						<div class="container-fluid">							
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6 col-md-5 col-lg-5 col-lg-offset-1 service-section-text-contianer" style="text-align: left">                                                            
                                                            ...
                                                            <p>BucksLocks Locksmith services provides 24 hr car key replacement services in Montgomery County PA.</p>
                                                    ...
                                                    <div class="row">
                                                        <div class="hidden-desktop col-sm-5 col-md-5 col-lg-4 col-lg-offset-0 service-section-img-container">	
                                                            <img src="<?php echo get_stylesheet_directory_uri() ?>/layout/images/car_keys_montgomery_mounty.jpg" alt="car keys Montgomery County">                                                       								                                                               
                                                        </div>
                                                        <div class="col-sm-5 col-sm-offset-1 col-md-5 col-md-offset-1 col-lg-5 col-lg-offset-1 service-section-text-contianer" style="text-align: left">                                                         

                                                            <p>
                                                               The BucksLocks offers a fast response mobile car key programming service with vehicle locksmiths covering the whole area of Montgomery County PA. It just takes one phone call. Every van is fully equipped
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 col-md-offset-2 col-lg-4 col-lg-offset-2 service-section-text-contianer" style="text-align: left">                                                         
                                                         ...
                                                         <div class="col-sm-5 col-sm-offset-1 col-md-5 col-md-offset-1 col-lg-4 col-lg-offset-1 service-section-text-contianer" style="text-align: left">
                                                         And any Auto Locksmith services you need in Montgomery County PA…
                                                         </div>
