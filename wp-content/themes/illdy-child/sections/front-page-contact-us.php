...
if ( $general_title != '' || $general_entry != '' || $general_address_title != '' || $address1 != '' || $address2 != '' || $customer_support_title != '' || $email != '' || $phone != '' || $contact_bar_twitter_url != ''
	...
	?>
        ...
        <span class="location-scroll" id="contact-us-location"></span>
				...
				<div class="row">
					<div class="col-sm-12">
						<?php //if ( class_exists( 'WPCF7' ) && $general_contact_form_7 != null && $general_contact_form_7 != 'default' && get_post($general_contact_form_7) ): ?>
							<?php $shortcode = '[contact-form-7 id="312" title="Contact form 1"]'; ?>
							...
							<div class="col-sm-4">
								<div class="contact-us-box">
									...
									<div class="box-right">
											...
											<span class="box-right-row">E-mail:
												<a href="mailto:buckslocks@gmail.com" title="buckslocks@gmail.com">buckslocks@gmail.com</a></span>																				
											<span class="box-right-row" data-customizer="contact-us-phone"><?php _e( 'Phone:', 'illdy' ); ?> (267)560-7065</span>
