	...
	<div class="bottom-header front-page">
		<div class="container">
			<div class="row">
					...
					<div class="col-sm-12">						
                                                <h1>
                                                    Locksmith in Bucks County, PA
                                                    <p>We offer local locksmith services to Bucks County, 
                                                    PA. It's only $15 for a service call. 100% satisfaction guaranteed.
                                                    Call us now for immediate service, we'll beat any price!</p>
                                                </h1>                                                
					</div><!--/.col-sm-12-->
				
                                        <div id="contact-number-bottom-header">                
